...
class Calendar(models.Model):
    users = models.ManyToManyField(
        User, related_name='user_calendars', blank=True, null=True)
    owner = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='owner_calendars')
...
class JournalImage(models.Model):
    journal = models.ForeignKey(
        Journal, on_delete=models.CASCADE, related_name='journal_images')
...
class JournalFile(models.Model):
    journal = models.ForeignKey(
        Journal, on_delete=models.CASCADE, related_name='journal_files')
